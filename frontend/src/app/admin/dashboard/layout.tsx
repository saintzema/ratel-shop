...
export default function AdminLayout({
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
            ...
            <aside
                className={cn(
                    "fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 transform transition-transform duration-200 ease-in-out md:translate-x-0 md:static md:h-screen",
                    isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                )}
            >
                <div className="p-6 flex items-center gap-2">
                    <ShieldAlert className="h-8 w-8 text-red-500" />
                    <span className="font-bold text-lg text-gray-900">Ratel Admin</span>
                </div>

                <div className="px-6 mb-2">
                    <div className="text-xs font-bold text-gray-400 uppercase tracking-wider">Super Admin</div>
                </div>
