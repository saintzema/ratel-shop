                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                                <div className="space-y-3">
                                                                    ...
                                                                    <div className="space-y-2 text-sm">
                                                                        ...
                                                                        {order.shipping_address && <p><span className="font-bold text-gray-500">Delivery:</span> <span className="font-medium"><DeliveryAddress value={order.shipping_address} /></span></p>}
                                                                    </div>
                                                                </div>
                                                                <div className="space-y-3">
