                            ...
                            .map(order => (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center">
                                        <Badge className={`${order.zivaActive ? "bg-ratel-green-100 text-ratel-green-700" : "bg-blue-100 text-blue-700"} border-none text-[10px]`}>
                                        ...
                                        {msg.sender === "system" ? (
                                            ...
                                            <div className={`max-w-[70%] flex flex-col ${msg.sender === "user" ? "items-start" : "items-end"}`}>
                                                <div className="flex items-center gap-2 mb-1 px-1">
                                                    {msg.sender === "ziva" && <span className="text-[10px] font-bold text-ratel-green-600">Ziva AI</span>}
                                                ...
                                                <div className={`px-4 py-2.5 rounded-2xl text-[13px] ${msg.sender === "user"
                                                    ...
                                                    : msg.sender === "ziva"
                                                        ? "bg-ratel-green-50 border border-ratel-green-100 text-ratel-green-900 rounded-tr-sm"
