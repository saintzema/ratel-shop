                ...
                if (u && u.id) {
                    ...
                    if (isSeller && sellerRec) {
                        ...
                        setUserEntity({
                            ...
                            phone_number: sellerRec.phoneNumber,
                            phone: sellerRec.phoneNumber,
                            whatsapp_number: sellerRec.whatsappNumber,
                            whatsapp_enabled: sellerRec.whatsappEnabled,
                        ...
                        <div className="bg-white/70 backdrop-blur-2xl rounded-[32px] border border-white/60 shadow-xl p-8">
                            ...
                            <div className="space-y-3">
                                {([
                                    ...
                                    { icon: Phone, label: "WhatsApp", value: userEntity.whatsapp_number ? `${userEntity.whatsapp_number}${userEntity.whatsapp_enabled ? "" : " (not enabled)"}` : undefined },
