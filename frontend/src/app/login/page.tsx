                            ...
                            {step === "identifier" && (
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center py-6">
                                        ...
                                        <span className="px-4 text-[13px] text-[#86868b] font-medium">or continue with</span>
                                        <div className="flex-grow border-t border-gray-200" />
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 44" className="h-[20px] w-auto fill-current shrink-0">
