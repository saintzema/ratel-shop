                ...
                <div className="bg-white border-b border-gray-100 pt-32 pb-12">
                    <div className="container mx-auto px-4">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black text-gray-900 leading-tight tracking-tight mb-4">
                            How much is <span className="text-emerald-600 italic">"{query}"</span> in Nigeria?
                        </h1>
                        <p className="text-lg text-gray-500 max-w-2xl font-medium">
                            Real-time market data for {query} across major Nigerian retailers. Updated as of April 2026.
                        </p>
                        <div className="mt-6 flex items-center gap-3 bg-emerald-50 px-4 py-2 rounded-2xl border border-emerald-100 w-fit">
                            <Globe className="h-4 w-4 text-emerald-600" />
                            <p className="text-sm font-bold text-emerald-800">
                                Buying for family in Nigeria? <span className="text-emerald-600">See the best local rates here.</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4 -mt-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <div className="bg-white rounded-[32px] p-8 shadow-xl shadow-emerald-900/5 border border-emerald-50 relative overflow-hidden">
                                ...
                                <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-8">
                                    <div>
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <div className="bg-emerald-600 text-white px-2 py-0.5 rounded flex items-center gap-1 text-[9px] font-black uppercase tracking-tighter">
                                ...
                                <div className="mt-12 pt-8 border-t border-gray-100 grid grid-cols-2 md:grid-cols-4 gap-6">
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-bold text-emerald-600 uppercase">FairPrice Official</p>
                                        <p className="font-black text-emerald-600">{formatPrice(comparisonData.fairPrice)}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-emerald-900 rounded-[32px] p-8 text-white">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="bg-emerald-800/50 p-4 rounded-2xl border border-emerald-700/50">
                                        <h4 className="font-bold text-sm mb-1 text-emerald-300">💡 Savings Tip</h4>
                                        <p className="text-xs text-emerald-100">Check for sellers with "FairPrice Verified" badges to avoid refurbished items sold as brand new.</p>
                                    </div>
                                    <div className="bg-emerald-800/50 p-4 rounded-2xl border border-emerald-700/50">
                                        <h4 className="font-bold text-sm mb-1 text-emerald-300">🔒 Secure Shopping</h4>
                                        <p className="text-xs text-emerald-100">Always use FairPrice Escrow. Never pay directly to bank accounts on Jiji or social media.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <Link href="/search" className="text-emerald-600 text-sm font-bold flex items-center gap-1 hover:underline">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {matches.slice(0, 6).map((product) => (
                                        <Link 
                                            ...
                                            className="group bg-white p-4 rounded-2xl border border-gray-100 flex gap-4 hover:shadow-lg hover:border-emerald-200 transition-all"
                                        >
                                            ...
                                            <div className="flex-1 min-w-0 flex flex-col justify-between">
                                                <div>
                                                    <h4 className="font-bold text-sm text-gray-900 truncate group-hover:text-emerald-600 transition-colors uppercase tracking-tight">{product.name}</h4>
                                                ...
                                                <div className="flex items-center justify-between mt-2">
                                                    ...
                                                    <span className="bg-emerald-600 text-white px-3 py-1.5 rounded-lg text-[10px] font-black uppercase shadow-lg shadow-emerald-200 group-hover:scale-105 transition-transform flex items-center gap-1">
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-[32px] p-6 border border-gray-100 shadow-sm sticky top-32">
                                <h4 className="font-black text-gray-900 mb-6 uppercase tracking-wider text-sm flex items-center gap-2">
                                    <TrendingUp className="h-4 w-4 text-emerald-600" /> Market Snapshot
                                </h4>
                                
                                <div className="space-y-6">
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm font-medium text-gray-500">Search Volume</span>
                                        <span className="text-sm font-black text-emerald-600">High (🔥)</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-sm font-black text-emerald-600">Save up to 15%</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {['iPhone 15', 'Samsung S24', 'Tesla Model 3', 'Solar Inverter', 'Nike Shoes', 'Gaming PC'].map(tag => (
                                        <Link 
                                            ...
                                            className="bg-white px-3 py-1.5 rounded-lg border border-gray-200 text-[11px] font-bold text-gray-600 hover:border-emerald-300 hover:text-emerald-700 transition-all"
                                        >
                                            {tag}
                                        </Link>
                                    ))}
