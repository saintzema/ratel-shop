                ...
                <div className="flex flex-col gap-3 bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <div className="border-t border-gray-200/60 pt-3 flex flex-col gap-2">
                        ...
                        <div className="grid grid-cols-5 gap-2 sm:gap-3">
                            ...
                            >
                                <div className={`h-8 w-8 shrink-0 rounded-full flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform ${copiedStoreLink ? 'bg-emerald-500 text-white' : 'bg-gray-100 text-gray-700'}`}>
                                    {copiedStoreLink ? (
