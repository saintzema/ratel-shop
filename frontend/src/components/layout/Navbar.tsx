            ...
            <header ref={headerRef} className="fixed left-0 right-0 w-full flex-col backdrop-blur-2xl backdrop-saturate-150 shadow-sm" style={{ background: 'rgba(10, 104, 71, 0.78)', position: 'fixed', top: 'var(--pwa-banner-h, 0px)', zIndex: 100 }}>
                ...
                < div className="flex w-full items-center justify-between bg-white/15 backdrop-blur-md px-2 md:px-4 py-1 md:py-1.5 text-xs md:text-sm text-white overflow-hidden border-t border-white/10" >
                    ...
                    < div className="flex items-center gap-1 shrink-0 overflow-x-auto no-scrollbar max-w-[100%] sm:max-w-[100%]" >
                        <Link href="/discover" className="flex items-center gap-1 whitespace-nowrap px-2.5 py-1 rounded-full transition-all text-[11px] md:text-[13px] font-bold bg-gradient-to-b from-[#ffd77a] to-[#f5b942] text-[#4a3200] shadow-sm hover:brightness-105">
                            <Compass className="w-3 h-3 md:w-3.5 md:h-3.5" /> Popular Spots
                        </Link>
                        <Link href="/hire" className="flex items-center gap-1 whitespace-nowrap px-2.5 py-1 rounded-full transition-all text-[11px] md:text-[13px] font-bold bg-gradient-to-b from-[#ffd77a] to-[#f5b942] text-[#4a3200] shadow-sm hover:brightness-105">
                            <Wrench className="w-3 h-3 md:w-3.5 md:h-3.5" /> Post Gigs & Jobs
                        </Link>
