            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute bottom-20 left-0 w-[calc(100vw-3rem)] max-w-[360px] md:w-[420px] md:max-w-none h-[70vh] max-h-[550px] md:h-[85vh] md:max-h-[680px] flex flex-col overflow-hidden shadow-2xl pointer-events-auto rounded-3xl border border-white/10 origin-bottom-left"
