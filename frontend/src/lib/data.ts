...
export const SEED_PRODUCTS: Product[] = [
    ...
    // ─── NEW: Home & Living ──────────────────────────────────
    {
        ...
        images: [], stock: 4, price_flag: "fair", is_sponsored: true, is_active: true,
...
export const DEMO_REVIEWS: Review[] = [
    ...
    { id: "r6", user_id: "u15", user_name: "Ngozi E.", product_id: "p16", rating: 5, title: "Holy Grail moisturizer", body: "It's La Mer, what else is there to say? It completely transformed my dry patches. Pricey but it lasts forever.", verified_purchase: true, created_at: "2026-02-05T09:30:00Z" },
    { id: "r7", user_id: "u16", user_name: "Sade O.", product_id: "p16", rating: 4, title: "Very rich cream", body: "A bit too heavy for the day in Lagos heat, so I use it strictly as a night cream. Waking up with glowing skin!", verified_purchase: true, created_at: "2026-01-28T14:15:00Z" },
    { id: "r8", user_id: "u17", user_name: "Dayo O.", product_id: "p14", rating: 5, title: "100% Authentic Jordan 1", body: "I was skeptical about buying sneakers on FairPrice, but the escrow gave me comfort. Brand new, perfectly authenticated. Love it.", verified_purchase: true, created_at: "2026-02-12T11:20:00Z" },
    { id: "r9", user_id: "u18", user_name: "Grace K.", product_id: "p44", rating: 5, title: "Best value for my twins", body: "You can't go wrong with Pampers Premium. The wetness indicator is a lifesaver, and getting this mega pack here is cheaper than the supermarket offline.", verified_purchase: true, created_at: "2026-02-14T10:45:00Z" },
    { id: "r10", user_id: "u19", user_name: "Mustapha I.", product_id: "p54", rating: 4, title: "No NEPA Wahala", body: "This solar camera is a game changer for my compound. Easy installation. Why 4 stars? The app takes a minute to load sometimes.", verified_purchase: true, created_at: "2026-02-03T16:20:00Z" },
    { id: "r11", user_id: "u20", user_name: "Efe M.", product_id: "p39", rating: 5, title: "Christmas/Sallah Staple", body: "Rice is clean, zero stones, and it didn't stick when I made Jollof. Arrived exactly in 2 days as promised.", verified_purchase: true, created_at: "2025-12-25T14:00:00Z" },
    { id: "r12", user_id: "u21", user_name: "Aisha T.", product_id: "p85", rating: 5, title: "My acne is finally clearing up", body: "Honestly, The Ordinary Niacinamide is magic. I can already see my dark spots fading after two weeks of consistent use.", verified_purchase: true, created_at: "2026-01-30T10:30:00Z" },
    { id: "r13", user_id: "u22", user_name: "Victor C.", product_id: "p96", rating: 5, title: "Perfect mix of power and portability", body: "The M2 chip is overkill for a tablet, but it's incredibly smooth. Use it for illustration and some light video editing.", verified_purchase: true, created_at: "2026-02-20T08:15:00Z" },
    { id: "r14", user_id: "u23", user_name: "Zainab S.", product_id: "p96", rating: 3, title: "Good tablet, awful battery drain", body: "Screen is amazing but the battery drains ridiculously fast when watching 4K videos. I miss my M1 iPad.", verified_purchase: true, created_at: "2026-02-10T11:45:00Z" },
    { id: "r15", user_id: "u24", user_name: "Olakunle A.", product_id: "p74", rating: 5, title: "Silent and fast", body: "Upgraded from a 2018 Intel Mac. The difference is night and day. Fanless design means zero noise, battery lasts two days of normal office work.", verified_purchase: true, created_at: "2026-01-22T09:20:00Z" },
    { id: "r16", user_id: "u25", user_name: "Chioma D.", product_id: "p130", rating: 5, title: "Splurge but totally worth it", body: "I justified this purchase for months. Now that I have the Dyson Airwrap, I haven't been to a salon. It literally does not damage hair. Magic.", verified_purchase: true, created_at: "2026-02-18T13:30:00Z" },
    { id: "r17", user_id: "u26", user_name: "Yusuf K.", product_id: "p116", rating: 4, title: "Best ANC in the game", body: "Noise cancellation is flawless, completely blocks out generator noise. I took off 1 star because they don't fold down compactly like the XM4s.", verified_purchase: true, created_at: "2026-02-08T15:10:00Z" },
    { id: "r18", user_id: "u27", user_name: "Simi F.", product_id: "p81", rating: 5, title: "Classic fit", body: "Can't beat the original Ray-Bans. The polarization is excellent for driving in the glaring afternoon sun.", verified_purchase: true, created_at: "2026-01-14T12:00:00Z" },
    { id: "r19", user_id: "u28", user_name: "Bolaji T.", product_id: "p18", rating: 5, title: "C3 OLED is unmatched", body: "PS5 gaming on this TV is out of this world. The 120Hz refresh rate and perfect blacks in HDR. Simply stunning.", verified_purchase: true, created_at: "2026-02-21T18:45:00Z" },
    { id: "r20", user_id: "u29", user_name: "Ngozi M.", product_id: "p41", rating: 5, title: "Saver pack!", body: "Indomie carton delivered to my doorstep without me having to drag it from the market. Highly convenient.", verified_purchase: true, created_at: "2026-01-11T14:30:00Z" },
    { id: "r21", user_id: "u30", user_name: "Uche W.", product_id: "p70", rating: 5, title: "Incredible Mouse", body: "The shape feels perfect in hand for intense gaming, and it is ridiculously light. Clicks are super crisp.", verified_purchase: true, created_at: "2026-01-25T19:20:00Z" },
    { id: "r22", user_id: "u31", user_name: "Ahmed G.", product_id: "p135", rating: 4, title: "Does everything", body: "I've stopped using my regular pots. This Instant pot makes amazing beans in literally 30 minutes without soaking. Only issue is the cord is a bit short.", verified_purchase: true, created_at: "2026-02-02T08:00:00Z" },
    { id: "r23", user_id: "u12", user_name: "Emeka I.", product_id: "p69", rating: 5, title: "Next Gen is here", body: "Xbox Series X paired with Game Pass is the best deal in gaming right now. Load times are non-existent thanks to the SSD.", verified_purchase: true, created_at: "2025-12-15T21:10:00Z" }
];
